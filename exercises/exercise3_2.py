...
_.Process(name=2,in_streams=[s3,s4],out_streams=[s5,s6])

_.extra_eqs += [
    _.sympy.Eq(K_novobiocin,s4[novobiocin].mass_concentration/s3[novobiocin].mass_concentration),
    _.sympy.Eq(K_novobiocin,s6[novobiocin].mass_concentration/s5[novobiocin].mass_concentration),
]
...
print("\nExpected return"+"""
V_{S2.solvent} = 516.197916666667
""".rstrip())